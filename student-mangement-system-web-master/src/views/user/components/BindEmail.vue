<template>
  <div class="set">
    ...
    <p>
      <el-form ref="toBindFormRef" :rules="toBindRules" status-icon :model="toBind" class="demo-form-inline">
        <el-row :gutter="20">
          ...
          <el-col :span="24" v-show="!showGetCode && !showNewEmail">
            <el-button plain color="#2fa7b9" @click="showGetCode = true" style="margin-left: 0px;">更换绑定邮箱
            </el-button>
          </el-col>
        </el-row>
      </el-form>
