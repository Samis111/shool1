      ...
      <el-table element-loading-text="数据加载中..." v-loading="loading" :data="tableData"
        ...
        <el-table-column label="学号">
          <template #default="scope">
            <el-tooltip :content="scope.row.studentId" palacement="top" effect="light">
              <span class="highlight">{{ scope.row.studentId }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        <el-table-column label="真实姓名">
          <template #default="scope">
            <el-tooltip :content="scope.row.studentName" palacement="top" effect="light">
              <span class="highlight">{{ scope.row.studentName }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        <el-table-column label="创建时间">
          <template #default="scope">
            <el-tooltip :content="scope.row.enrollmentDate" placement="top" effect="light">
              <span class="highlight">{{ formatTime(scope.row.enrollmentDate, 'yyyy-MM-dd') }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
