      ...
      <div class="card-header">
        ...
        <div class="card-search">
          <el-row :gutter="10">
            ...
            <el-col :span="11">
              <div class="my-button">
                <el-button plain style="width: 100%;" color="#2fa7b9" @click="addTeacher">添加信息</el-button>
    ...
    <div class="table-box">
      <el-table element-loading-text="数据加载中..." v-loading="loading" :data="tableData"
        ...
        <el-table-column label="创建时间">
          <template #default="scope">
            <el-tooltip :content="scope.row.eventDate" placement="top" effect="light">
              <span class="highlight">{{ formatTime(scope.row.eventDate, 'yyyy-MM-dd') }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <!-- <el-button size="small" @click="editTeacher(scope.row.studentId)"
            ...
            <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" :icon="Delete" icon-color="#626AEF"
              :title="'确定删除名为“' + scope.row.name + '”记录？'" @confirm="delTeacher(scope.row.rpId)">
              <template #reference>
