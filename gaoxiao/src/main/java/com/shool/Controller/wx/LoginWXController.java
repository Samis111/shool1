package com.shool.Controller.wx;
...
//  孙appSecret  c7d7d587e080c1dda3b07c7a6ff47f96
    ...
    @Autowired
    private StudentsService kehuService;
...
//            Students kehuEntity = AddOrUpdate(openid, session_key);
...
//            loginresponse.setUserInfo(kehuEntity);
    ...
    private Students AddOrUpdate(String openID, String sessionKey) {
        Students kehuEntity = new Students();
      //  kehuEntity.setOpenId(openID);
     //   kehuEntity.setSessionkey(sessionKey);
        Students info = kehuService.getOne(new QueryWrapper<Students>().eq("open_id", openID));
        if(info == null) {
